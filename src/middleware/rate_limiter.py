...
def get_user_id_or_ip(request: Request) -> str:
    ...
    if auth.startswith("Bearer "):
        ...
        if len(parts) == 3:
            try:
                # Base64-decode the payload segment (second of three JWT parts).
                # JWT base64url encoding may omit padding — restore it before decoding.
                payload_b64 = parts[1]
                ...
                # Malformed JWT — fall through to IP fallback silently.
                pass
