...
from src.helpers.pdf_cleaner import clean_extracted_pages
...
def retrieve_from_knowledge_base(
    ...
    if azure_client.search_endpoint and azure_client.search_api_key:
        try:
            ...
            clean_results = [
                ...
                and (r.get("document") or r.get("text") or r.get("content"))
            ]
