...
def test_calculate_coverage_extracts_labeled_indices():
    ...
    clauses_with_section = [
        ...
        ClauseSpan(
            clause_type="Indemnification", raw_text="Details", section_reference="Clause 12"
        ),
    ]
    res = calculate_coverage(contract_text="Section 5. Clause 12.", clauses=clauses_with_section)
...
def test_calculate_coverage_extracts_clean_start_numbers():
    ...
    res = calculate_coverage(
        contract_text="1. Definitions. 2. Term.", clauses=clauses_with_clean_nums
    )
