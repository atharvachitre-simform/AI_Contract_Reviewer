...
SYNTHESIS_SYSTEM_PROMPT = "You are a professional contract reviewer and plain English writer."
...
def build_synthesis_prompt(summaries_text: str) -> str:
    """Build prompt for synthesizing multiple executive summaries."""
    return SYNTHESIS_USER_PROMPT_TEMPLATE.format(summaries_text=summaries_text)
