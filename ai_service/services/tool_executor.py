...
from ai_service.prompts.system_context import BUSINESS_DOMAIN_HEADER, DEFAULT_AGENT_SYSTEM_PROMPT
from ai_service.services.content_filter import sanitize_prompt_for_content_filter
from ai_service.services.langfuse_tracer import LangFuseTracer
from ai_service.services.tool_implementations import PIPELINE_TOOLS_SCHEMA, execute_pipeline_tool
                    ...
                    try:
                        ...
                        if trace_id and tracer.enabled:
                            tracer.log_generation(
                                ...
                                model=kwargs.get("model", llm_client.deployment_name),
            ...
            if message.tool_calls:
                ...
                for tc in message.tool_calls:
                    ...
                    try:
                        ...
                        logger.warning(f"Failed to parse tool arguments for {t_name}, using empty dict")
                        t_args = {}
