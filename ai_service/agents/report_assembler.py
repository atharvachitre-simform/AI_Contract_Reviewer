...
from ai_service.utils.llm_parsing import parse_llm_json_response
...
from ai_service.agents.risk_scorer import normalize_risk_level
...
class ReportAssemblerState(TypedDict):
    ...
    obligation_finding: ObligationFinderOutput | None
